...
import com.client.R;
import com.clientBase.fragment.CarFragment;
import com.clientBase.fragment.MyFragment;
...
public class FrameworkActivity extends FragmentActivity implements OnClickListener {
	...
	private CarFragment imFragment;
...
//
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 初始化布局元素
		initViews();
		findViewById(R.id.cityInfor).setOnClickListener(clickListener);
	...
	private OnClickListener clickListener = new OnClickListener() {
		...
		public void onClick(View v) {
			switch (v.getId()) {
				case R.id.cityInfor:// 打开左边抽屉
					Intent intent = new Intent(FrameworkActivity.this, SearchActivity.class);
