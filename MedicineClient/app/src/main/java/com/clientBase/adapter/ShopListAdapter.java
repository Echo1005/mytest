...
public class ShopListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.mtvTime.setText("类型：" + list_result.get(position).getShopTypeName());
			holder.mtvcity.setText("库存：" + list_result.get(position).getShopNumber());
	...
	private class ViewHolder {
		private TextView mTvTitle,mtvcity;
