...
public class CarOrderAdapter extends BaseAdapter {
    ...
    public CarOrderAdapter(Context context, List<CarModel> list_result) {
        mContext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.mTvMoney.setText("单价：" + list_result.get(position).getShopMoney() + "元");
        holder.mtvTime.setVisibility(View.VISIBLE);
        holder.mtvTime.setText("数量："+list_result.get(position).getCarNumber() + "件");
