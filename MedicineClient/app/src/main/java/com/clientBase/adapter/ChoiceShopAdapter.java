...
public class ChoiceShopAdapter extends BaseAdapter {
	...
	public ChoiceShopAdapter(Context mContext) {
		super();
		this.mContext = mContext;
	}

	public ChoiceShopAdapter(Context mContext, List<ShopModel> list_msg) {
		super();
		this.mContext = mContext;
	...
	public List<ShopModel> setData(List<ShopModel> list_str) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		vh.zoom_msg.setText(list_result.get(position).getShopName());
		return convertView;
	}
