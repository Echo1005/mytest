...
public class ShopListSendAdapter extends BaseAdapter {
	private LayoutInflater inflater;
	private List<ShopModel> list_result;
	private int posIndex;
	private Context mContext;
	public ShopListSendAdapter(Context context, List<ShopModel> list_result) {
		mContext = context;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			holder.mtvTime.setText("时间：" + list_result.get(position).getShopCreatime());
