...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	private List<SelectImageItem> infos;
	...
	public void setData(List<ImageView> views, List<SelectImageItem> list, ImageCycleViewListener listener) {
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, List<SelectImageItem> list, ImageCycleViewListener listener, int showPosition) {
	...
	public static interface ImageCycleViewListener {
		 ...
		 * @param imageView
		 */
		public void onImageClick(SelectImageItem info, int postion, View imageView);
	}
}