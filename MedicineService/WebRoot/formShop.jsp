...
<body>
	<form name="form2" action="" method="post"  enctype="multipart/form-data">
		...
		<div class="formbody">
			...
			<ul class="forminfo">
				<li><label>药品名称</label><input name="shopName" type="text" class="dfinput" /></li>
				...
				<li><label>药品金额</label><input name="shopMoney" type="text" class="dfinput" /></li>
				<li><label>药品库存</label><input name="shopNumber" type="text" class="dfinput" /></li>
				<li><label>药品说明</label><textarea name="shopMessage" cols="" rows="" class="textinput"></textarea></li>
				<li><label>药品图片</label><input name="bookImage" type="file" class="dfinput" size="60"></li>
